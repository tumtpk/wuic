...
class Admission extends CI_Controller {
    ...
    public function directadmission(){
        ...
        $data['breadcrumb'] = array(
            array("page"=>"Home", "url"=>base_url(), "icon"=>"fa fa-home"),
            array("page"=>"Admission", "url"=>"#", "icon"=>"fa fa-angle-right"),
            array("page"=>"Direct Admission", "url"=>base_url()."admission/directadmission", "icon"=>"fa fa-angle-right")
        );
        
        $this->load->view('page/head');
        $this->load->view('page/menu');
        $this->load->view('page/header_page', $data);
        $this->load->view('admission/directadmission');
        $this->load->view('page/news');
        $this->load->view('page/footer');
        $this->load->view('page/foot');
    }
