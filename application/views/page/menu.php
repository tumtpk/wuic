<!--================Header Menu Area =================-->
<header class="no-border main_menu_area" style="position:  absolute;background-color: #fbfbfdd6;">
   <nav class="navbar navbar-expand-lg navbar-light bg-light">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent" style="font-size: 32px;">
         <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item">
               <div class="dropdown show" href="#">
                  <a class="dropdown-toggle" href="#" id="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="font-size: 16px;color: #686964;">Admission</a>
                  <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                     <a class="dropdown-item lineheight" href="<?= base_url(); ?>admission/overall">Admission Period</a>
            ...
            <li class="nav-item">
               <div class="dropdown show" href="#">
                  <a class="dropdown-toggle" href="#" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="font-size: 16px;color: #686964;">Study at WUIC</a>
                  <div class="dropnav dropdown-menu" aria-labelledby="dropdownMenuLink">
                     ...
                     <a class="dropdown-item lineheight" href="<?= base_url(); ?>study/scholarships">Undergraduate Excellent Scholarship</a>
            ...
            <li class="nav-item">
               <div class="dropdown show" href="#">
                  <a class="dropdown-toggle" href="#" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="font-size: 16px;color: #686964;">Life on Campus</a>
                  <div class="dropnav dropdown-menu" aria-labelledby="dropdownMenuLink">
            ...
            <li class="nav-item"><a class="nav-link" href="<?= base_url(); ?>contact/index" style="font-size: 16px;color: #686964;">Contact us</a></li>
            <!-- <?= base_url(); ?>main/about -->
         </ul>
      </div>
   </nav>
