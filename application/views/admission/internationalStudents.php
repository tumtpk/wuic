                     ...
                     <div class="static_text2">
                        ...
                        <div class="table-responsive table-bordered"  border-style: solid;border-color: coral;>
                            <table class="table">
                                    ...
                                    <tr class="">
                                        <td   style="text-align: center; vertical-align: middle;" rowspan="4"> <strong>ACT</strong></td>
                                        <td>Mathematics</td>
                                        <td style="text-align: center;vertical-align: middle;" rowspan="4">Composite Score 21.5 from 36 (Math ≥ 20 and Science ≥ 20)</td>
                                        <td style="text-align: center;vertical-align: middle;" rowspan="4">Composite Score 21.5 from 36 (English ≥ 20 and Reading ≥ 20)</td>
                                        <td style="text-align: center;vertical-align: middle;" rowspan="4">Composite Score 21.5 from 36 (Math ≥ 20 and English ≥ 20)</td>
                                    </tr>
                                    <tr class="">
                                        <td>Science</td>
                                    </tr>
                                    ...
                                    <tr class="">
                                        <td   style="text-align: center; vertical-align: middle;" rowspan="2"> <strong>IB (Higher or Standard Level)</strong></td>
                                        <td>Mathematics</td>
                                    ...
                                    <tr class="">
                                        <td style="text-align: center;" colspan="4">Grade 1 = A*</td>
                                    </tr>
                                    <tr class="">
                                        <td style="text-align: center;" colspan="4">Grade 2 = A</td>
                                    </tr>
                                    <tr class="">
                                        <td style="text-align: center;" colspan="4">Grade 3-5 = B</td>
                                    </tr>
                                    <tr class="">
                                        <td style="text-align: center;" colspan="4">Grade 6-7 = C</td>
                                    </tr>
                                    <tr class="">
                                        <td style="text-align: center;" colspan="4">Grade 8-9 = F</td>
                                    </tr>
                            </table>
                        </div>
                     </div>
