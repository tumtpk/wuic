               ...
               <div class="col-lg-9">
                  <div class="static_main_content">
                     ...
                     <div class="static_img">
                        ...
                        <h4>Applicant Qualification</h4>
                     </div>
                     <div class="media">
                        <div class="media-body">
                           <p>
                                Applicants must have completed or are going to complete high school / 
                                ต้องเป็นนักเรียนที่สำเร็จหรือกำลังจะสำเร็จการศึกษาระดับมัธยมศึกษาตอนปลาย
                           </p>
                        </div>
                     </div>
                  </div>
